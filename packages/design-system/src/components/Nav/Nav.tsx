...
import type { NavProps, NavLink } from './types';
      ...
      <div className={containerClasses()}>
        ...
        <nav className={navBarClasses()}>
          ...
          >
            <span
              aria-hidden="true"
              className={firstSpanClasses({ open: isOpen })}
            ></span>
            <span
              aria-hidden="true"
              className={secondSpanClasses({ open: isOpen })}
            ></span>
            <span
              aria-hidden="true"
              className={thirdSpanClasses({ open: isOpen })}
            ></span>
          </button>
